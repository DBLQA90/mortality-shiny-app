...
for (f in c("R/config.R", "R/helpers.R", "R/regions.R", "R/metrics.R", "R/standardisation.R", "R/avoidable.R", "R/infant.R", "R/regional_rows.R", "R/planning_parish.R", "R/planning_indicators.R", "R/life_expectancy.R", "R/planning_under75.R", "R/planning_standardised.R", "R/planning_sns.R", "R/planning_weekly.R", "R/planning_export.R", "R/planning_charts.R", "R/planning_profile.R", "R/data_versions.R", "R/forecast_helpers.R")) {
