...
write_planning_workbook <- function(path,
  ...
  readme <- c(
    ...
    "‡ esperança de vida em que mais de 2% dos óbitos do triénio não tinham idade publicada por município e foram distribuídos pelas idades na proporção dos restantes; as regiões usam as linhas por idade do próprio INE.",
